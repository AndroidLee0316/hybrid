...
public class Constants {
    ...
    // http 请求method
    public static final String KEY_METHOD = "_xxxx_method";
    // post 请求
    ...
    public static final String IMAGE_TYPE = "imageType=base64";
    public static final String VIDEO_TYPE = "videoType=base64";
    public static final String AUDIO_TYPE = "audioType=base64";
    public static final String IMAGE_KEY = "?imageType";
    public static final String VIDEO_KEY = "?videoType";
    public static final String AUDIO_KEY = "?audioType";
    ...
    public static long TEMP_CLEAR_CACHE_TIME;
}
