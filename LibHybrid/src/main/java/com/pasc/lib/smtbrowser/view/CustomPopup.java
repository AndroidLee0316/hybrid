...
public class CustomPopup extends PopupWindow {
    ...
    private List<IconTextBean> iconTextBeans=new ArrayList<> ();
    ...
    private void initAdapter() {
        listAdapter = new IconTextAdapter (mContext,iconTextBeans);
...
//        itemTextList.add(new Pair<String, Integer>(itemText, iconResId));
        iconTextBeans.add (new IconTextBean (iconResId,itemText));
        itemListenerList.add(listener);
        itemSize = itemListenerList.size();
    }
...
//        itemTextList.add(map);
        iconTextBeans.add (new IconTextBean (url,itemText));
        itemListenerList.add(listener);
        itemSize = itemListenerList.size();
    }
